...
Принцип "явное лучше неявного" является одним из основных принципов программирования и дизайна языков программирования. Этот принцип гласит, что код должен быть написан таким образом, чтобы его намерения и результаты были очевидными и понятными для читателя, а не скрытыми или неявными. Мы придерживаемся этого принципа не только когда пишем код.

#### Практики

- Использовать понятные имена, которые отражают их назначение и функциональность.
- Избегать использования "магических чисел".
- Избегать использования инструментов, работу которых можно объяснить только фразой "это какая-то магия".
- В своей повседневной работе визуализировать свои мысли и идеи через любые сервисы miro/draw.io чтобы читателю и/или слушателю было проще воспринимать информацию.
- Голосом выражать свои мысли и не ожидать что кто-то в состоянии их прочитать (люди пока не умеют читать мысли).
- Включать камеры на online встречах, чтобы показывать слушателям свое мнение насчет поднимаемого вопроса невербально (мимикой и жестами).
- Eсли не понятны требования/ожидания от задачи - уточни и пропиши явно.
- Eсли процесс не описан - значит он не существует.

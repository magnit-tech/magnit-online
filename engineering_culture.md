...
Явное лучше неявного. Принцип "явное лучше неявного" является одним из основных принципов программирования и дизайна языков программирования. Этот принцип гласит, что код должен быть написан таким образом, чтобы его намерения и результаты были очевидными и понятными для читателя, а не скрытыми или неявными.

В основе этого принципа лежит идея, что когда программисты читают и понимают код, они должны быть в состоянии легко определить, что делает код и как он работает, без необходимости просматривать большое количество дополнительной информации или догадываться о том, что происходит "под капотом".
Применение этого принципа может помочь улучшить читаемость кода, упростить его отладку и облегчить сопровождение и расширение кода в будущем.

#### Практики

- Использовать понятные имена, которые отражают их назначение и функциональность.
- Избегать использования "магических чисел" или неочевидных констант, вместо этого использовать именованные константы или переменные с понятными именами.
- Избегать излишней сложности и вложенности в коде, разбивая его на более простые и понятные функции или блоки кода.
- Четко указывать зависимости и импорты, чтобы было ясно, откуда берутся используемые функции и объекты.
- Использовать комментарии и документацию для объяснения сложных или неочевидных частей кода.
- Ответственность прозрачна и публична, мы всегда можем подсказать кто отвечает «вот за это», или подсветить, что есть что-то бесхозное.
